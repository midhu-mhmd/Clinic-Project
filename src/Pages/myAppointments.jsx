...
const MyAppointments = () => {
        ...
        return (
            <div className="h-screen w-full flex items-center justify-center bg-[#F0FDFA]">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-[10px] uppercase tracking-[0.4em] text-[#1E293B]/40 font-bold">Loading appointments...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-[#F0FDFA] text-[#1E293B] pt-32 pb-20 px-6 font-sans">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6 header-reveal">
                    <div className="space-y-4">
                        ...
                        <h1 className="text-6xl font-light tracking-tighter uppercase leading-none">
                            My <span className="italic font-serif text-[#0F766E]">Appointments</span>
                        </h1>
                    </div>
                    <div className="flex items-center gap-3 px-6 py-3 bg-white border border-[#1E293B]/5 rounded-full shadow-sm">
                ...
                {appointments.length === 0 ? (
                    <div className="py-32 flex flex-col items-center justify-center text-center space-y-6 bg-white border border-[#1E293B]/5 rounded-[40px] shadow-sm appointment-card">
                        <div className="w-20 h-20 bg-[#F0FDFA] rounded-full flex items-center justify-center text-[#1E293B]/10">
                            <Calendar size={40} />
                        </div>
                        ...
                        <button
                            ...
                            className="mt-4 px-10 py-4 bg-[#1E293B] text-white text-[10px] uppercase tracking-[0.3em] font-bold rounded-full hover:bg-[#0F766E] transition-all duration-500 shadow-xl"
                        >
                            Book New Protocol
                        </button>
                    </div>
                    ...
                    <div className="grid gap-4">
                        {appointments.map((apt) => (
                            <div
                                key={apt._id}
                                className="appointment-card group bg-white border border-[#1E293B]/5 rounded-[32px] p-8 md:p-10 flex flex-col md:flex-row md:items-center justify-between gap-8 hover:shadow-2xl hover:border-[#0F766E]/20 transition-all duration-700"
                            >
                                <div className="flex items-start gap-8">
                                    {/* DOCTOR ICON/IMAGE */}
                                    <div className="relative">
                                        <div className="w-20 h-20 bg-[#F0FDFA] rounded-2xl flex items-center justify-center overflow-hidden border border-[#1E293B]/5 group-hover:scale-105 transition-transform duration-700">
                                            {apt.doctorId?.image ? (
                                                ...
                                                <User size={32} className="text-[#1E293B]/10" />
                                            )}
                                        </div>
                                        <div className={`absolute -bottom-2 -right-2 w-8 h-8 rounded-xl border-4 border-white flex items-center justify-center shadow-sm ${apt.status === "CONFIRMED" ? "bg-[#0F766E]" :
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <p className="text-[9px] uppercase tracking-[0.3em] font-bold text-[#0F766E] mb-1">Your Doctor</p>
                                        ...
                                        <div className="flex flex-wrap gap-x-8 gap-y-3">
                                            <div className="flex items-center gap-2 text-[#1E293B]/40">
                                                <Building2 size={14} className="group-hover:text-[#0F766E] transition-colors" />
                                                <span className="text-[10px] uppercase tracking-widest font-bold">
                                                    {apt.tenantId?.name || "General Clinic"}
                                                </span>
                                            </div>
                                            <div className="flex items-center gap-2 text-[#1E293B]/40">
                                                <Calendar size={14} className="group-hover:text-[#0F766E] transition-colors" />
                                                <span className="text-[10px] uppercase tracking-widest font-bold">
                                                    {new Date(apt.dateTime).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                                                </span>
                                            </div>
                                            <div className="flex items-center gap-2 text-[#1E293B]/40">
                                                <Clock size={14} className="group-hover:text-[#0F766E] transition-colors" />
                                                <span className="text-[10px] uppercase tracking-widest font-bold">
                                ...
                                <div className="flex md:flex-col items-center md:items-end justify-between gap-4 md:border-l md:border-[#1E293B]/5 md:pl-10">
                                    <div className="text-right">
                                        <p className="text-[9px] uppercase tracking-[0.2em] font-bold opacity-30 mb-1">Status Protocol</p>
                                        <span className={`text-[10px] font-bold tracking-[0.2em] uppercase px-4 py-1.5 rounded-full ${apt.status === "CONFIRMED" ? "bg-[#0F766E]/10 text-[#0F766E]" :
                                    ...
                                    <button
                                        ...
                                        className="flex md:w-full items-center justify-center gap-2 text-[9px] uppercase tracking-[0.2em] font-bold text-[#1E293B]/40 hover:text-[#1E293B] transition-colors group/btn"
                                    >
                                    ...
                                    {apt.consultationType === "video" && apt.meetingLink && ["PENDING", "CONFIRMED"].includes(apt.status) && (
                                        <button
                                            ...
                                            className="flex md:w-full items-center justify-center gap-2 text-[9px] uppercase tracking-[0.2em] font-bold text-white bg-[#0F766E] px-4 py-2.5 rounded-full hover:bg-[#1E293B] transition-all duration-500"
                                        >
                ...
                {/* SECURITY INFO */}
                <div className="mt-24 p-10 bg-[#1E293B] text-white rounded-[40px] flex flex-col md:flex-row items-center justify-between gap-8 appointment-card overflow-hidden relative group">
                    <div className="relative z-10 space-y-4">
                        <div className="flex items-center gap-3">
                            <div className="p-2 bg-white/10 rounded-lg">
                                <AlertCircle size={18} className="text-[#0F766E]" />
                            </div>
                    ...
                    <div className="relative z-10">
                        ...
                        <button className="px-8 py-4 bg-white text-[#1E293B] text-[10px] uppercase tracking-[0.3em] font-bold rounded-full hover:bg-[#0F766E] hover:text-white transition-all duration-500">
                            Clinical Support
                        </button>
                    </div>
                </div>
                ...
                {selectedAppointment && (
                    <div className="fixed inset-0 z-[200] flex items-center justify-center px-6">
                        <div
                            className="modal-backdrop absolute inset-0 bg-[#1E293B]/60 backdrop-blur-sm"
                            onClick={closeModal}
                        />
                        <div
                            ref={modalRef}
                        ...
                        >
                            {/* MODAL HEADER */}
                            <div className="bg-[#1E293B] p-8 md:p-12 text-white relative">
                                <button
                                    onClick={closeModal}
                                    className="absolute top-8 right-8 w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#0F766E] transition-all"
                                >
                                    <ArrowLeft size={16} className="rotate-90 md:rotate-0 md:-rotate-45" />
                                </button>
                                <p className="text-[10px] uppercase tracking-[0.4em] font-bold text-[#0F766E] mb-4">Appointment Details</p>
                                <h2 className="text-4xl md:text-5xl font-light uppercase tracking-tighter">
                                    Appointment <span className="italic font-serif text-[#0F766E]">Summary</span>
                                </h2>
                            </div>
                            ...
                            <div className="p-8 md:p-12 space-y-10 max-h-[60vh] overflow-y-auto custom-scrollbar">
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 bg-[#F0FDFA] rounded-xl flex items-center justify-center border border-[#1E293B]/5">
                                ...
                                <hr className="border-[#1E293B]/5" />

                                {/* SECTION: PATIENT DATA */}
                                <div className="space-y-6">
                                    <p className="text-[9px] uppercase tracking-widest font-bold text-[#0F766E]">Patient Information</p>
                                    <div className="grid md:grid-cols-2 gap-6 bg-[#F0FDFA] p-8 rounded-3xl border border-[#1E293B]/5">
                                ...
                                <div className="space-y-4">
                                    <p className="text-[9px] uppercase tracking-widest font-bold text-[#0F766E]">Symptoms & Notes</p>
                                    <div className="p-8 border border-[#1E293B]/10 rounded-3xl italic text-sm text-[#1E293B]/70 leading-relaxed">
                            ...
                            {/* MODAL FOOTER */}
                            <div className="p-8 bg-[#F0FDFA] border-t border-[#1E293B]/5 flex justify-end gap-4">
                                {selectedAppointment.consultationType === "video" && selectedAppointment.meetingLink && ["PENDING", "CONFIRMED"].includes(selectedAppointment.status) && (
                                    <button
                                        ...
                                        className="px-10 py-4 bg-[#0F766E] text-white text-[10px] uppercase tracking-[0.3em] font-bold rounded-full hover:bg-[#1E293B] transition-all flex items-center gap-2"
                                    >
                                ...
                                <button
                                    onClick={closeModal}
                                    className="px-10 py-4 bg-[#1E293B] text-white text-[10px] uppercase tracking-[0.3em] font-bold rounded-full hover:bg-[#0F766E] transition-all"
                                >
                                    Close Record
                                </button>
                            </div>
                ...
                .custom-scrollbar::-webkit-scrollbar-thumb { background: #0F766E; border-radius: 10px; }
            `}} />
            </div>
        </div>
    );

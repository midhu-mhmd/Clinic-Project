  ...
  return (
    <div ref={mainRef} className="bg-[#F0FDFA] text-[#1E293B] min-h-screen">
      <main className="px-8 lg:px-16 pt-32 pb-20">
        <header className="mb-32 border-b border-[#1E293B]/10 pb-20">
          <div className="overflow-hidden mb-4">
            <h1 className="header-reveal text-[clamp(3.5rem,10vw,10rem)] font-light leading-[0.8] tracking-tighter uppercase italic font-serif text-[#0F766E]">
              Trusted
            </h1>
          </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-end mt-16 gap-12">
            <p className="max-w-md text-[#1E293B]/50 font-light text-xl leading-relaxed italic">
              "Connect with providers verified for clinical excellence across our global network of clinics."
            </p>
            <div className="w-full lg:w-100">
              <div className="flex items-center gap-4 border-b border-[#1E293B]/10 py-4 group focus-within:border-[#0F766E] transition-all">
          ...
          {doctors.length > 0 ? (
            doctors.map((doc, index) => (
              <div
                ...
                className="doctor-row group relative grid grid-cols-1 lg:grid-cols-12 items-center py-10 px-4 border-b border-[#1E293B]/5 hover:bg-[#0F766E]/5 transition-all duration-700 cursor-pointer"
              >
                ...
                <div className="lg:col-span-4 flex items-center gap-8">
                  <div className="relative w-20 h-28 overflow-hidden grayscale brightness-110 group-hover:grayscale-0 group-hover:brightness-100 transition-all duration-1000 rounded-sm bg-[#1E293B]/5">
                    <img
                  ...
                  <div>
                    <h2 className="text-3xl font-light tracking-tighter group-hover:text-[#0F766E] transition-colors duration-500 uppercase">
                      {doc.name}
                    </h2>
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      {doc.tenantId?.name && (
                        <>
                          ...
                          <span className="text-[9px] uppercase tracking-[0.2em] font-bold text-[#0F766E]">
                            {doc.tenantId.name}
                          </span>
                        </>
                      )}
                ...
                <div className="lg:col-span-3 flex items-center justify-end gap-10">
                  ...
                  <button
                    ...
                    className="relative bg-[#1E293B] text-[#F0FDFA] px-10 py-5 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-[#0F766E] transition-all duration-700 flex items-center gap-4 group/btn"
                  >

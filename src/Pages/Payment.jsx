...
const Payment = () => {
  ...
  const inputStyle =
    "peer w-full bg-transparent border-b border-gray-200 py-3 text-sm focus:outline-none focus:border-black transition-colors duration-500 placeholder-transparent font-light";
  const labelStyle =
        ...
        <div className="max-w-md w-full">
          <form onSubmit={handlePayment}>
            ...
            <div className={inputGroupStyle}>
              ...
              />
              <label htmlFor="cardName" className={labelStyle}>
                Cardholder Name
              </label>
            </div>
            ...
            <div className="pt-12">
              ...
              >
                <span>
                  {loading ? "Authenticating..." : `Pay $${price}.00`}
                </span>
                <span className="group-hover:translate-x-2 transition-transform duration-500 text-xl font-light">
                  →
                </span>
              </button>

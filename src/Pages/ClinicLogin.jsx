...
const ClinicLogin = () => {
  ...
  const inputStyle = "peer w-full bg-transparent border-b border-gray-200 py-4 text-sm focus:outline-none focus:border-black transition-all duration-500 placeholder-transparent font-light";
  const labelStyle = "absolute left-0 top-4 text-gray-400 text-[10px] tracking-[0.2em] uppercase transition-all duration-500 pointer-events-none peer-focus:-top-4 peer-focus:text-black peer-[:not(:placeholder-shown)]:-top-4";
    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-8 font-sans antialiased text-[#1a1a1a]">
      <div className="w-full max-w-[1000px] grid md:grid-cols-2 gap-20 items-center">
        ...
        <div className="hidden md:block">
          <h2 className="text-[10px] tracking-[0.5em] text-gray-400 uppercase mb-8">Access Portal</h2>
          <h1 className="text-[5vw] leading-[1.1] font-light tracking-tighter mb-8">
            Welcome back to <br />
            <span className="italic font-serif text-gray-400">your workspace.</span>
          </h1>
          <div className="h-px w-12 bg-black mb-8 opacity-20"></div>
          <p className="text-gray-400 text-sm font-light max-w-[280px] leading-relaxed">
            Enter your credentials to manage your clinic and AI patient interactions.
          </p>
        </div>
        ...
        <div className="w-full max-w-sm mx-auto md:mx-0">
          ...
          <form onSubmit={handleLogin} className="space-y-10">
            ...
            >
              ...
              <span className="group-hover:translate-x-2 transition-transform duration-500 font-light text-xl">→</span>
            </button>
          </form>

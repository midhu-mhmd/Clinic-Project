  ...
  const plans = [
    {
      ...
      features: ["Up to 3 Doctors", "1,000 Appointments/mo", "Basic AI Assistant", "Email Support"],
      cta: "Select Standard",
      recommended: false
    },
    {
      ...
      features: ["Unlimited Doctors", "Unlimited Appointments", "Custom AI Training", "24/7 Priority Support", "Advanced Analytics"],
    ...
    <div className="min-h-screen bg-white text-[#1a1a1a] font-sans antialiased py-20 px-8">
      <div className="max-w-[1200px] mx-auto">
        ...
        <header className="mb-24">
          <h2 className="text-[10px] tracking-[0.5em] text-gray-400 uppercase mb-8">Step 02 / Subscription</h2>
          <h1 className="text-[5vw] md:text-[4vw] leading-[1.1] font-light tracking-tighter">
            Choose a plan that <br />
            <span className="italic font-serif text-gray-400">fits your scale.</span>
          </h1>
        </header>
            ...
            >
              <div>
                <div className="flex justify-between items-start mb-12">
                  <h3 className="text-[12px] tracking-[0.3em] uppercase font-bold">{plan.name}</h3>
                  {plan.recommended && (
                    <span className="text-[9px] tracking-widest uppercase bg-black text-white px-3 py-1">Recommended</span>
                  )}
                </div>
                ...
                <div className="mb-12">
                  <div className="flex items-baseline">
                    ...
                    <span className="text-gray-400 text-sm ml-2 uppercase tracking-widest">/ Month</span>
                  </div>
                  <p className="mt-6 text-gray-500 font-light leading-relaxed max-w-[240px]">
                    {plan.description}
                  </p>
                </div>
                ...
                <ul className="space-y-4 mb-16">
                  {plan.features.map((feature, index) => (
                    <li key={index} className="flex items-center text-sm font-light text-gray-600">
              ...
              <button 
                onClick={() => navigate("/payment", { state: { plan: plan.name, price: plan.price } })}
              ...
              >
                <span>{plan.cta}</span>
                <span className="text-lg font-light transform group-hover:translate-x-2 transition-transform">→</span>
              </button>
            </div>
          ))}
        </div>

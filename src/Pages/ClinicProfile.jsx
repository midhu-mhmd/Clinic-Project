      ...
      >
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="Clinic Interior"
          />
          <div className="absolute inset-0 bg-linear-to-t from-[#FAF9F6] via-transparent to-transparent opacity-60" />
        </div>
        ...
        <div className="relative z-10 w-full flex flex-col md:flex-row justify-between items-end gap-12">
          ...
          <div className="flex flex-col items-end gap-10 text-[#FAF9F6] text-right">
            <p className="max-w-70 text-[11px] uppercase tracking-widest font-bold opacity-70 leading-relaxed">
              Advanced clinical care meets architectural serenity in the heart
              of San Francisco.
            </p>
          ...
          <div className="lg:col-span-7 space-y-32">
            <section className="info-block">
              ...
              <p className="text-xl text-[#2D302D]/60 font-light leading-relaxed italic max-w-2xl">
                "Our team of board-certified specialists uses technical
                precision and architectural calm to ensure the patient journey
                is as restorative as the treatment itself."
              </p>
            </section>
            ...
            <div className="info-block sticky top-32 bg-[#2D302D] text-[#FAF9F6] p-12 space-y-12 rounded-sm shadow-2xl">
              ...
              <div className="space-y-6">
                ...
                <p className="text-sm text-[#FAF9F6]/40 font-light italic leading-relaxed">
                  Consultations start from $80. Instant verification available
                  via our secure AI protocol.
                </p>
              </div>
          ...
          {["Dr. Sarah Jenkins", "Dr. Michael Chen"].map((name, i) => (
            ...
            >
              ...
              <div className="text-center lg:text-left">
                <span className="text-[9px] uppercase tracking-[0.4em] font-bold text-[#8DAA9D] block mb-4">
                  Senior Specialist
                </span>
                <h4 className="text-4xl font-light tracking-tighter uppercase group-hover:text-[#8DAA9D] transition-all duration-500 mb-4">
                  {name}
                </h4>
                <div className="flex items-center justify-center lg:justify-start gap-4">
                  <span className="text-[10px] opacity-40 uppercase tracking-widest font-bold">
                    12Y Clinical Experience
                  </span>
                  <Plus
                    size={14}
                    className="opacity-20 group-hover:rotate-90 transition-transform duration-500"
                  />
                </div>
              </div>
            </div>

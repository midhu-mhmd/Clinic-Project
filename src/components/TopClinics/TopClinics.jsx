...
const STATIC_CLINICS = [
  ...
  },
  {
    ...
    rate: 4.6,
    img: "https://images.unsplash.com/photo-1586773860418-d3b978ec017e?auto=format&fit=crop&q=80&w=800",
  },
  {
    id: 3,
    name: "Aster Medcity",
    location: "Kochi",
    specialty: ["Pediatrics", "Wellness"],
    rate: 4.9,
      ...
      <div className="h-screen flex flex-col justify-center relative">
        ...
        >
          {STATIC_CLINICS.map((clinic) => (
            <article
              key={clinic.id}
              className="clinic-card group relative shrink-0 w-[85vw] md:w-105 bg-white border border-neutral-100 p-6 transition-all duration-500 hover:border-[#8DAA9D]/30"
            >
              {/* Image Section */}
